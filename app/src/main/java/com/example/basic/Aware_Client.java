...
import com.example.basic.Aware_Client;
//import com.aware.phone.ui.Aware_Participant;
...
public class Aware_Client extends Aware_Activity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefs = getSharedPreferences("com.example.basic", Context.MODE_PRIVATE);
    ...
    private class AsyncPing extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                if (package_info.packageName.equals("com.example.basic")) {
            ...
            try {
                new Https(SSLManager.getHTTPS(getApplicationContext(), "https://compwell.ece.rice.edu/AWARE/index.php/webservice/index/25/obl56DNEE2mw")).dataPOST("https://compwell.ece.rice.edu/AWARE/index.php/webservice/index/25/obl56DNEE2mw", device_ping, true);
            //new Https(SSLManager.getHTTPS(getApplicationContext(), "https://api.awareframework.com/index.php")).dataPOST("https://api.awareframework.com/index.php/awaredev/alive", device_ping, true);
                // https://compwell.ece.rice.edu/AWARE/index.php/webservice/index/25/obl56DNEE2mw
